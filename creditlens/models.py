...
class LoanObservation(BaseModel):
    ...
    # Realistic Institutional Banking & KYC Fields
    applicant_name: Optional[str] = Field(None, description="Full Name of applicant")
    masked_id: Optional[str] = Field(None, description="Masked National ID / Aadhar / SSN")
    email: Optional[str] = Field(None, description="Applicant verified email")
    phone: Optional[str] = Field(None, description="Applicant phone number")
    employer_name: Optional[str] = Field(None, description="Employer / Company Name")
    work_sector: Optional[str] = Field(None, description="Employment sector e.g. IT, Healthcare, Government")
    employment_type: Optional[str] = Field(None, description="Permanent (Full-time) vs Contract vs Self-Employed")
    layoff_risk: Optional[str] = Field(None, description="Sector layoff vulnerability assessment")
    bank_balance: Optional[float] = Field(None, description="Verified liquid bank account balance")
    requested_doc_details: Optional[Dict[str, Any]] = Field(None, description="Details of verified requested document")
